...
function toggleForm(id) {
    ...
    if (["tarjetaForm", "paypalForm", "applePayForm"].includes(id)) {
        if (form.classList.contains("show")) {
            ...
            let paymentForms = document.querySelectorAll("#tarjetaForm, #paypalForm, #applePayForm");
...
function setPaymentRequired(selectedId) {
    const paymentForms = ["tarjetaForm", "paypalForm", "applePayForm"];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const paymentInputs = document.querySelectorAll("#tarjetaForm input, #paypalForm input, #applePayForm input");
    ...
    document.getElementById("formularioCompra").addEventListener("submit", function (event) {
        ...
        let paymentOption = document.querySelector("#tarjetaForm.show, #paypalForm.show, #applePayForm.show");
        if (!paymentOption) {
            event.preventDefault();
